<template>
	...
	<!-- Lien autour de l'image avec le titre de l'activité -->
		<header>
			...
			<h1 class="titre">Titre de l'activité</h1>
			<div class="vignette">
				<div class="vignette-content">
					<p>Lieu de l'activité</p>
					<p>Distance de l'activité {{ distance }}</p>
				</div>
			</div>
		</header>
    <!-- Bandelette avec la date et le nom de la catégorie -->
        ...
        <section class="activity-section">
            <h1 class="activity-title">Randonnée charmante au bord d'un lac et près d'une forêt</h1>
            <p class="activity-date">11 Novembre, à 12h12</p>
            <p class="activity-description">Cette randonnée vous fera perdre la tête! De
            cours d'eau enchanteurs aux sommets
            ravissants. vous serez revigorés par cette
            balade d'un charme authentique.</p>
            <div class="address">
                ...
                <address>
                    Avenue de la Libération, 17<br>
                    8731 Beau Village<br>
                </address>
             </div>
        </section>
      ...
      <div class="px-2">Jean-Denis Charles Jacques</div>
